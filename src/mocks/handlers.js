...
import { ADMIN_EMAIL, ADMIN_EMPLOYEE, ADMIN_ROLE, EMPLOYEE_EMAIL, HTTP_INVALID_CREDENTIALS_STATUS, HTTP_OK_STATUS } from '../consts'
...
export const handlers = [
    rest.post('/login', (req, res, ctx) => {
        ...
        return res(ctx.status(200), ctx.json({ user: { role, username: 'Jhon Doe' } }))
    }),
]
